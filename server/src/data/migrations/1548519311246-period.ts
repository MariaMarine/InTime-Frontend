...
export class period1548519311246 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `chart_reports` DROP FOREIGN KEY `FK_a3f88a9fcfb779ed8c855ec7b4c`");
        await queryRunner.query("ALTER TABLE `table_reports` ADD `period` int NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `table_reports` DROP COLUMN `period`");
